...
for i in range(len(cells) - 1):
    ...
    model.algebraic[cells[i].pos.phi] = opp * (cells[i].pos.phi - (cells[i].pos.phi))
...
model.algebraic[cells[-1].pos.phi] = cells[-1].pos.phi - cells[-1].pos.phi
model.algebraic[cells[-1].neg.phi] = cells[-1].neg.phi - cells[-1].neg.phi
